...
S = 64 // sub
T_in = 10  # 1#10
T = 40  # 49#40 # T=40 for V1e-3; T=20 for V1e-4; T=10 for V1e-5;
...
dataset_name = 'navier'
parent_dir = './data/'
dataset_filename = parent_dir + dataset_name + '_S' + str(S) + 'T' + str(T_in) + 'to' + str(T) + '.pt'
...
plt.figure()
plt.contourf(x_test_plot, y_test_plot, a_ind, levels=500, cmap='hsv')
plt.colorbar()
...
plt.figure()
plt.contourf(x_test_plot, y_test_plot, u_exact, levels=500, cmap='hsv')
plt.colorbar()
plt.gca().set_aspect('equal', adjustable='box')
...
plt.figure()
plt.contourf(x_test_plot, y_test_plot, u_pred - u_exact, levels=500, cmap='hsv')
plt.colorbar()
plt.gca().set_aspect('equal', adjustable='box')
plt.title('Error')
plt.show()
