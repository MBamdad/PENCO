...
# Network Parameters
nTrain = 50 # 1000 # 1200 # 900 # 1000
nTest = 10 # 200 # 300 # 100 # 100
batch_size = 5 # 20 # 50 # 20 #5 # 25
learning_rate = 0.02 # 0.001
weight_decay = 1e-4
epochs = 25 # 50 # 50 # 100 # 900  # 100
...
Lx = 5.0 # np.pi # 1.0 # Domain size (assuming Lx=Ly=Lz based on MATLAB)
Ly =Lx
Lz= Lx
index = 4 # 13 # 62  # 24 # 62
#domain = [-np.pi, np.pi] ######
...
pde_loss_scaler =  1e0 # pde_loss_scaler = 100.0
# Two-Phase Optimization Parameters
adam_epochs = 50      # Number of epochs for the initial Adam phase
lbfgs_epochs = 0   # Number of epochs for the L-BFGS refinement phase
bc_weight = 1000.0  # <-- ADD THIS NEW PARAMETER
