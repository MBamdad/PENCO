...
FigDraw = 0; % Set to 0 to disable plotting
...
% Dataset
data_size = 1200;
binary_filename = "PFC3D_" + num2str(data_size) + "_Nt_" + num2str(num_saved_steps) + "_Nx_" + num2str(Nx) + ".bin";
mat_filename = "PFC3D_" + num2str(data_size) + "_Nt_" + num2str(num_saved_steps) + "_Nx_" + num2str(Nx) + ".mat";
